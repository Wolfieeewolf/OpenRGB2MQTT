...
QT_MOC_LITERAL(3, 29, 17), // "mqttConfigChanged"
QT_MOC_LITERAL(4, 47, 16) // "ddpConfigChanged"

    },
    "ConfigManager\0configChanged\0\0"
    "mqttConfigChanged\0ddpConfigChanged"
};
...
void ConfigManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->mqttConfigChanged(); break;
        case 2: _t->ddpConfigChanged(); break;
        default: ;
        }
        ...
        {
            using _t = void (ConfigManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConfigManager::mqttConfigChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ConfigManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConfigManager::ddpConfigChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void ConfigManager::mqttConfigChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void ConfigManager::ddpConfigChanged()
{
