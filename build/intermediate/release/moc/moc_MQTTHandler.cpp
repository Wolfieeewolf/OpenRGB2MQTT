...
QT_MOC_LITERAL(7, 77, 15), // "connectionError"
QT_MOC_LITERAL(8, 93, 5), // "error"
QT_MOC_LITERAL(9, 99, 13), // "handleMessage"
QT_MOC_LITERAL(10, 113, 7), // "message"
QT_MOC_LITERAL(11, 121, 14), // "QMqttTopicName"
QT_MOC_LITERAL(12, 136, 17), // "handleStateChange"
QT_MOC_LITERAL(13, 154, 11), // "handleError"
QT_MOC_LITERAL(14, 166, 19) // "processMessageQueue"

    },
    "MQTTHandler\0messageReceived\0\0topic\0"
    "payload\0connectionStatusChanged\0"
    "connected\0connectionError\0error\0"
    "handleMessage\0message\0QMqttTopicName\0"
    "handleStateChange\0handleError\0"
    "processMessageQueue"
};
...
static const uint qt_meta_data_MQTTHandler[] = {
 ...
 // slots: parameters
    QMetaType::Void, QMetaType::QByteArray, 0x80000000 | 11,   10,    3,
    QMetaType::Void,
    QMetaType::Void,
    QMetaType::Void,
...
void MQTTHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->handleMessage((*reinterpret_cast< const QByteArray(*)>(_a[1])),(*reinterpret_cast< const QMqttTopicName(*)>(_a[2]))); break;
        case 4: _t->handleStateChange(); break;
        ...
        {
            using _t = void (MQTTHandler::*)(const QString & , const QByteArray & );
        ...
        {
            using _t = void (MQTTHandler::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MQTTHandler::connectionStatusChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MQTTHandler::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MQTTHandler::connectionError)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void MQTTHandler::messageReceived(const QString & _t1, const QByteArray & _t2)
{
...
// SIGNAL 1
void MQTTHandler::connectionStatusChanged(bool _t1)
{
...
// SIGNAL 2
void MQTTHandler::connectionError(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
